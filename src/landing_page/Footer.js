        ...
        <div className="container mt-5" style={{ marginBottom: "1rem" }}>
          <div className="row">
            ...
            {isSupportPage ? (
              <>
                <div className="col-3 mt-1 social_icon">
                  ...
                  >
                    <i class="fas fa-phone"></i>&nbsp; 080 47181888
                  </h4>
                  <p className="small mt-3 text-muted">
                    &copy; 2010 - 2025, Zerodha Broking Ltd. <br /> All rights
                    reserved.
                  </p>
                  <Link to={"https://x.com/mdafzal14786"}>
                    <i class="fab fa-twitter icon-first"></i>
                  </Link>
                  <Link to={"https://facebook.com/mdafzal14786"}>
                    <i class="fab fa-facebook-square icons"></i>
                  </Link>
                  <Link to={"https://instagram.com/mdafzal14786"}>
                    <i class="fab fa-instagram icons"></i>
                  </Link>
                  <Link to={"https://linkedin.com/in/mdafzal14786"}>
            ...
            {isSupportPage ? (
              <>
                <div className="col ">
                  ...
                  <ul className="list-unstyled mt-3">
                    <li className="links mt-2">
                      <a href="/about" className="text-muted link" target="_blank">
                        About
                      </a>
                    </li>
                    <li className="links mt-2">
              ...
              <>
                ...
                <div className="col mt-1">
                  ...
                  <ul className="list-unstyled mt-3">
                    <li className="links">
                      <a href="/signup" className="text-muted link" target="_blank">
                        Open demat account
                      </a>
                    </li>
                    <li className="links mt-2">
            ...
            {isSupportPage ? (
              <>
                <div className="col">
                  ...
                  <ul className="list-unstyled mt-3">
                    <li className="links">
                      <a href="/support" className="text-muted link">
                        Contact
                      </a>
                    </li>
                    <li className="links mt-2">
              ...
              <>
                ...
                <div className="col ">
                  ...
                  <ul className="list-unstyled mt-3">
                    ...
                    <li className="links mt-2">
                      <a href="https://zerodha.tech/" className="text-muted link" target="_blank">
                        Zerodha.tech
                      </a>
                    </li>
                    <li className="links mt-2">
                      <a href="https://github.com/zerodha" className="text-muted link" target="_blank">
                        Open source
                      </a>
                    </li>
                  </ul>
            ...
            {isSupportPage ? (
              ...
              <>
                <p className="mt-4 text-muted font">
                  ...
                  Zerodha Commodities Pvt. Ltd. MCX: 46025; NSE-50001 &#8722;
                  SEBI Registration no.: INZ000038238 Registered Address:
                  Zerodha Broking Ltd., #153/154, 4th Cross, Dollars Colony,
                ...
                <p className="mt-1 text-muted font">
                  ...
                  securities as margins from clients only by way of pledge in
                  the depository system w.e.f September 01, 2020. 2&#41; Update
                  your e-mail and phone number with your stock broker /
                  depository participant and receive OTP directly from
                  depository on your e-mail and/or mobile number to create
                  pledge. 3&#41; Check your securities / MF / bonds in the
                ...
                <div className="row text-center">
                  <div className="col mb-4">
                    <a
                      href="#"
                      className="policies-links-first policies-links text-muted small"
                    >
                      BSE
                    </a>
                    <a href="#" className="policies-links text-muted small">
                      NSE
                    </a>
                    <a href="#" className="policies-links text-muted small">
                      MCX
